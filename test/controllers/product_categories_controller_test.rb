...
class ProductCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_category" do
    assert_difference('ProductCategory.count') do
      post product_categories_url, params: { product_category: { active: @product_category.active, name: @product_category.name } }
    end

    assert_redirected_to product_category_url(ProductCategory.last)
  end

  test "should edit product_category" do
  ...
  test "should update product_category" do
    patch product_category_url(@product_category), params: { product_category: { active: @product_category.active, name: @product_category.name } }
